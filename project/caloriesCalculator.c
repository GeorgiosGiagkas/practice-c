...
int main(){
  ...
  printf("\n\nThis a basic C program for applying basic concepts of the language, such as pointers, structures, dynamic memory allocation etc.This program calculates daily caloric needs based on two different approaches using The World Organization Equation (WHO) and the Mifflin-St. Jeor Equation (MSJ). The program takes the following inputs:\n\n1.Name: No more than 80 characters without spaces.\n2.Surname: Same as name.\n3.Sex: Type m for male or f for female.\n4.Age: As a positive integer value.\n5.Weight: As a positive integer or float number.\n6.Height: Same as weight.\n\nThere are 6 action implemented in the program.Press <number> and <enter> in the manu screen.\n1.Insert a new entry (ex name, surname etc.).\n2.Print the results of all entries in the screen and see the results of calories calculated.\n3.Save file as outputFile.txt in the current working directory.\n4.Read data from txt file.\n5.Print menu of available actions.\n6.Ternminate the program.\nThe program %s has been created by G.G. and compiled at %s, in %s.\n", __FILE__,__TIME__, __DATE__);
